...
const contact = () => {
	return (
		<div className="flex min-h-screen w-full flex-col items-center justify-between container mx-auto py-32 relative 2xl:px-36 px-8">
			<section className="container mx-auto px-8 text-left sm:text-center max-w-3xl">
